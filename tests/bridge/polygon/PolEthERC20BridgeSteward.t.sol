...
contract PolEthERC20BridgeStewardTest is Test {
    ...
    function setUp() public {
        ...
        bridgeMainnet = new PolEthERC20BridgeSteward{salt: salt}(
            OWNER,
            GUARDIAN,
        ...
        bridgePolygon = new PolEthERC20BridgeSteward{salt: salt}(
            OWNER,
            GUARDIAN,
...
contract RescueEthTest is PolEthERC20BridgeStewardTest {
    ...
    function test_successful_ownerCaller() public {
        ...
        uint256 initialCollectorAaveBalance = address(AaveV3Ethereum.COLLECTOR)
            .balance;
        ...
        assertEq(
            ...
            initialCollectorAaveBalance + amount
        );
        assertEq(address(bridgeMainnet).balance, 0);
    }
}
...
contract MaxRescueTest is PolEthERC20BridgeStewardTest {
    function test_maxRescue() public {
        vm.selectFork(mainnetFork);
        assertEq(
            bridgeMainnet.maxRescue(AaveV3EthereumAssets.USDC_UNDERLYING),
            0
        );
