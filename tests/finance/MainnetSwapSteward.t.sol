...
contract MainnetSwapStewardTest is Test {
  ...
  address public constant USDT_PRICE_FEED = 0xC26D4a1c46d884cfF6dE9800B6aE7A8Cf48B4Ff8;
  ...
  function _setBudgetAndPath() internal {
    ...
    steward.setSwappablePair(AaveV3EthereumAssets.USDC_UNDERLYING, AaveV3EthereumAssets.AAVE_UNDERLYING, true);
...
contract ConstructorTest is Test {
  ...
  function test_revertsIf_milkmanIsZeroAddress() public {
    vm.expectRevert(IMainnetSwapSteward.InvalidZeroAddress.selector);
    new MainnetSwapSteward(
      GovernanceV3Ethereum.EXECUTOR_LVL_1,
      makeAddr("guardian"),
  ...
  function test_revertsIf_priceCheckerIsZeroAddress() public {
    vm.expectRevert(IMainnetSwapSteward.InvalidZeroAddress.selector);
    new MainnetSwapSteward(
      GovernanceV3Ethereum.EXECUTOR_LVL_1,
      makeAddr("guardian"),
  ...
  function test_revertsIf_limitPriceCheckerIsZeroAddress() public {
    vm.expectRevert(IMainnetSwapSteward.InvalidZeroAddress.selector);
    new MainnetSwapSteward(
      GovernanceV3Ethereum.EXECUTOR_LVL_1,
      makeAddr("guardian"),
  ...
  function test_revertsIf_relayerIsZeroAddress() public {
    vm.expectRevert(IMainnetSwapSteward.InvalidZeroAddress.selector);
    new MainnetSwapSteward(
      GovernanceV3Ethereum.EXECUTOR_LVL_1,
      makeAddr("guardian"),
  ...
  function test_successful() public {
    MainnetSwapSteward steward = new MainnetSwapSteward(
      GovernanceV3Ethereum.EXECUTOR_LVL_1,
      makeAddr("guardian"),
      address(AaveV3Ethereum.COLLECTOR),
      MILKMAN,
    ...
    assertEq(steward.COLLECTOR(), address(AaveV3Ethereum.COLLECTOR));
...
contract LimitSwapTest is MainnetSwapStewardTest {
  ...
  function test_revertsIf_insufficientBudget() public {
    ...
    vm.startPrank(guardian);
    vm.expectRevert(IMainnetSwapSteward.InsufficientBudget.selector);
    steward.limitSwap(AaveV3EthereumAssets.USDC_UNDERLYING, AaveV3EthereumAssets.AAVE_UNDERLYING, 2_000e6, 900e6);
    vm.stopPrank();
  }
...
contract CancelSwapTest is MainnetSwapStewardTest {
  ...
  function test_successful() public {
    ...
    assertEq(steward.tokenBudget(AaveV3EthereumAssets.USDC_UNDERLYING), budgetBefore - 1_000e6);
    ...
    assertEq(IERC20(AaveV3EthereumAssets.USDC_UNDERLYING).allowance(address(steward), steward.milkman()), 0);
    vm.stopPrank();
  }

  function test_successful_doesNotRemoveTwapSwapBalance() public {
    _setBudgetAndPath();
    ...
    steward.swap(AaveV3EthereumAssets.USDC_UNDERLYING, AaveV3EthereumAssets.AAVE_UNDERLYING, 500e6, 200);
    vm.stopPrank();

    assertEq(steward.tokenBudget(AaveV3EthereumAssets.USDC_UNDERLYING), budgetBefore - 500e6);
    ...
    uint256 balanceCollectorBefore = IERC20(AaveV3EthereumAssets.USDC_UNDERLYING).balanceOf(steward.COLLECTOR());

    assertEq(IERC20(AaveV3EthereumAssets.USDC_UNDERLYING).balanceOf(address(steward)), amount * numParts);

    vm.expectEmit(true, true, true, true, address(steward));
    emit SwapCanceled(AaveV3EthereumAssets.USDC_UNDERLYING, AaveV3EthereumAssets.AAVE_UNDERLYING, 500e6);
    steward.cancelSwap(
      0x1aEE9BE6489A40366350Dd623c54e488DCb839c3, // Address generated by tests
      AaveV3EthereumAssets.USDC_UNDERLYING,
      AaveV3EthereumAssets.AAVE_UNDERLYING,
    ...
    assertEq(
      IERC20(AaveV3EthereumAssets.USDC_UNDERLYING).balanceOf(steward.COLLECTOR()), balanceCollectorBefore + 500e6
    );

    uint256 balanceAfter = IERC20(AaveV3EthereumAssets.USDC_UNDERLYING).balanceOf(address(steward));

    assertEq(balanceAfter, amount * numParts);
...
contract CancelTWAPSwapTest is MainnetSwapStewardTest {
  ...
  function test_revertsIf_orderDoesNotExist() public {
    _setBudgetAndPath();
    ...
    vm.expectRevert(IMainnetSwapSteward.OrderDoesNotExist.selector);
    steward.cancelTwapSwap(
      AaveV3EthereumAssets.USDC_UNDERLYING,
      AaveV3EthereumAssets.AAVE_UNDERLYING,
      amount + 1,
...
contract SetSwappablePairTest is MainnetSwapStewardTest {
  ...
  function test_revertsIf_sameToken() public {
    vm.startPrank(GovernanceV3Ethereum.EXECUTOR_LVL_1);
    vm.expectRevert(IMainnetSwapSteward.UnrecognizedTokenSwap.selector);
    steward.setSwappablePair(AaveV3EthereumAssets.USDC_UNDERLYING, AaveV3EthereumAssets.USDC_UNDERLYING, true);
    vm.stopPrank();
  }

  function test_success_setToTrue() public {
    vm.startPrank(GovernanceV3Ethereum.EXECUTOR_LVL_1);

    vm.expectEmit(true, true, true, true, address(steward));
    emit SetSwappablePair(AaveV3EthereumAssets.USDC_UNDERLYING, AaveV3EthereumAssets.AAVE_UNDERLYING, true);
    steward.setSwappablePair(AaveV3EthereumAssets.USDC_UNDERLYING, AaveV3EthereumAssets.AAVE_UNDERLYING, true);
    vm.stopPrank();
  }

  function test_success_setBackToFalse() public {
    vm.startPrank(GovernanceV3Ethereum.EXECUTOR_LVL_1);
    ...
    assertTrue(steward.swapApprovedToken(AaveV3EthereumAssets.USDC_UNDERLYING, AaveV3EthereumAssets.AAVE_UNDERLYING));

    vm.expectEmit(true, true, true, true, address(steward));
    emit SetSwappablePair(AaveV3EthereumAssets.USDC_UNDERLYING, AaveV3EthereumAssets.AAVE_UNDERLYING, false);
    steward.setSwappablePair(AaveV3EthereumAssets.USDC_UNDERLYING, AaveV3EthereumAssets.AAVE_UNDERLYING, false);

    assertFalse(steward.swapApprovedToken(AaveV3EthereumAssets.USDC_UNDERLYING, AaveV3EthereumAssets.AAVE_UNDERLYING));
    vm.stopPrank();
  }
}
...
contract SetRelayerTest is MainnetSwapStewardTest {
  ...
  function test_relayerWithTokens_revertsIf_invalidCaller() public {
    address[] memory tokens = new address[](1);
    tokens[0] = AaveV3EthereumAssets.USDC_UNDERLYING;

    vm.expectRevert(abi.encodeWithSelector(Ownable.OwnableUnauthorizedAccount.selector, address(this)));
    steward.setRelayer(makeAddr("new-relayer"), tokens);
  }

  function test_relayerWithTokens_revertsIf_invalidZeroAddress() public {
    address[] memory tokens = new address[](1);
    tokens[0] = AaveV3EthereumAssets.USDC_UNDERLYING;

    vm.startPrank(GovernanceV3Ethereum.EXECUTOR_LVL_1);
    vm.expectRevert(IMainnetSwapSteward.InvalidZeroAddress.selector);
    steward.setRelayer(address(0), tokens);
  }

  function test_milkmanWithTokens_successful() public {
    address newRelayer = makeAddr("new-relayer");
    address[] memory tokens = new address[](1);
    tokens[0] = AaveV3EthereumAssets.USDC_UNDERLYING;
    ...
    address oldRelayer = steward.relayer();

    assertEq(IERC20(AaveV3EthereumAssets.USDC_UNDERLYING).allowance(address(steward), oldRelayer), amount * numParts);

    vm.startPrank(GovernanceV3Ethereum.EXECUTOR_LVL_1);
    vm.expectEmit(true, true, true, true, address(steward));
    emit RelayerAddressUpdated(steward.relayer(), newRelayer);
    steward.setRelayer(newRelayer, tokens);

    assertEq(steward.relayer(), newRelayer);
    assertEq(IERC20(AaveV3EthereumAssets.USDC_UNDERLYING).allowance(address(steward), oldRelayer), 0);
  }
}
...
contract RescueTokenTest is MainnetSwapStewardTest {
  ...
  function test_rescueWithAmount_revertsIf_invalidCaller() public {
    vm.expectRevert(abi.encodeWithSelector(IWithGuardian.OnlyGuardianOrOwnerInvalidCaller.selector, address(this)));
    steward.rescueToken(AaveV2EthereumAssets.AAVE_UNDERLYING, 1_000e6);
  }
  ...
  function test_rescueWithAmount_successful_governanceCaller() public {
    assertEq(IERC20(AaveV2EthereumAssets.AAVE_UNDERLYING).balanceOf(address(steward)), 0);
    ...
    vm.startPrank(GovernanceV3Ethereum.EXECUTOR_LVL_1);
    steward.rescueToken(AaveV2EthereumAssets.AAVE_UNDERLYING, aaveAmount / 2);
    vm.stopPrank();

    assertEq(
      IERC20(AaveV2EthereumAssets.AAVE_UNDERLYING).balanceOf(address(AaveV2Ethereum.COLLECTOR)),
      initialCollectorAaveBalance + aaveAmount / 2
    );
    assertEq(IERC20(AaveV2EthereumAssets.AAVE_UNDERLYING).balanceOf(address(steward)), aaveAmount / 2);
  }
}
...
contract GetExpectedOutTest is MainnetSwapStewardTest {
  function test_successful() public {
    vm.startPrank(GovernanceV3Ethereum.EXECUTOR_LVL_1);
    steward.setTokenOracle(AaveV3EthereumAssets.USDC_UNDERLYING, USDC_PRICE_FEED);
    steward.setTokenOracle(AaveV3EthereumAssets.USDT_UNDERLYING, USDT_PRICE_FEED);

    assertApproxEqAbs(
      steward.getExpectedOut(1_000e6, AaveV3EthereumAssets.USDC_UNDERLYING, AaveV3EthereumAssets.USDT_UNDERLYING),
      1_000e6,
      1e6
    );
  }
